...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4126a3d17659581ac1b74ebba17f9e2de59d0d6677285e7ded4fabff465b9065.js',function(){input.required=false;search();});}
