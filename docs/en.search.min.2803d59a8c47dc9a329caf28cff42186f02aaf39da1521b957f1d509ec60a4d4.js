...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bd3e7282f03ab443cdd86ba61333d493230dd29a8eb37befcf5f706d6564038c.js',function(){input.required=false;search();});}
