...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3e415462884094c054d102767dadd493712a0b7e051401ea9fae5a9b35c6644a.js',function(){input.required=false;search();});}
