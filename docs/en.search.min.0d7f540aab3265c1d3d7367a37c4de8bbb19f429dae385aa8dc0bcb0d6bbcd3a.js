...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.57913e4bcc3101d6a519e7fdc1e9e261d3e6189dd0d506798f75fcf9b937d87b.js',function(){input.required=false;search();});}
