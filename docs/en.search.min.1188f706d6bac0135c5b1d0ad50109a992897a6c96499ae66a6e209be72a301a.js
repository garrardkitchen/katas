...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ddb3a65c2428ac72ab3be29bf6bf83fbaa14854e6b727f084d2890e092df1a28.js',function(){input.required=false;search();});}
