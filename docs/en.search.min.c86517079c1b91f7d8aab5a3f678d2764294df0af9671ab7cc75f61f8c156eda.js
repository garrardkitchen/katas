...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9b6736331af411d6ccc8b26cc9427018ea4d8043de578dedd6ab916d6adc294e.js',function(){input.required=false;search();});}
