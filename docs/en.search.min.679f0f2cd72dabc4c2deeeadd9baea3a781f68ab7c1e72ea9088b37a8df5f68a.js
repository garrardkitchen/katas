...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2e423aa66522ec6f6418ac19605524edcfda859fbcaa8e42b68f72e0f47a89d8.js',function(){input.required=false;search();});}
